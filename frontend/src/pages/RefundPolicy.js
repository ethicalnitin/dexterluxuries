        ...
        <div className="refund-container">
          ...
          <div className="reveal" ref={addRef}>
            ...
            <p className="refund-sub">
              At <span className="highlight">MKR Tools & Softwares</span>, we take pride in delivering premium digital products.
          ...
          <div className="refund-section reveal" ref={addRef}>
            ...
            <p style={{ marginTop: "20px" }}>
              Thank you for trusting <span className="highlight">MKR Tools & Softwares</span>.
            </p>
          </div>
